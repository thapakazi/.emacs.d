...
(org-babel-load-file (concat user-emacs-directory "blog.org"))
(org-babel-load-file (concat user-emacs-directory "authorize.org"))
(org-babel-load-file (concat user-emacs-directory "config.org"))
;; (org-babel-load-file (concat user-emacs-directory "ror.org"))
;; (org-babel-load-file (concat user-emacs-directory "org-mdode.org"))
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (elfeed edit-server magit helm-ag helm-projectile helm c-eldoc ace-jump-mode ido-vertical-mode transpose-frame ox-pandoc use-package cyberpunk-theme))))
(custom-set-faces
